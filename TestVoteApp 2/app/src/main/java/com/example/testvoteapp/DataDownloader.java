...
public class DataDownloader {
    ...
    public static void MainCivicDataDownloader(MainActivity mainActivity , String location){
        ...
        try{
            ...
            for (int i = 0; i < officesArray.length(); i++){
                ...
                for (int j = 0; j < officialIndicesArray.length(); j++) {
                    ...
                    String photoUrlStr; if (officialDetailsArray.has("photoUrl")){
                         photoUrlStr = officialDetailsArray.getString("photoUrl");
