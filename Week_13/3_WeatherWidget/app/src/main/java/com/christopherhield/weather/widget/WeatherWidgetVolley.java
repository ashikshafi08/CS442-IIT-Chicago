...
public class WeatherWidgetVolley {
    ...
    public static void getWeatherData(
            Context context, String input, WeatherWidget weatherWidget) {
    ...
    private static void getIcon(String icon, WeatherWidget weatherWidget) {
